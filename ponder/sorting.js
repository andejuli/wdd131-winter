...
let productSort = products.sort(compareObjectFn);
...
let lowerCaseList = simpleList.map(item => item.toLowerCase());
...
//Similar to Homework (recipes part 2)
